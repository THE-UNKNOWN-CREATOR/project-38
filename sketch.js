var player; var gravity = 0.8; var jumpHeight = -15; var ground; var jumpSpace = 360; var obstacle = []; 
var spawnRate = 2; var enemySpeed = 3; var score = 0; var scoreIncrement = 1;
var start = 0, play = 1, end = 2, begin = 3, win = 4;
...
function draw()
{
  ...
  if(gameState === begin)
  {
    ...
    var inf = createButton(" Infinite Mode ");
    inf.position(150, 350);
  ...
  for(var i = 0; i<obstacle.length; i++)
  {
    ...
    if(obstacle[i].x < player.x-200-obstacle[i].width)
    {
      obstacle[i].destroy();
      //obstacle.pop();
      //score++;
